...
board = Arduino('COM3')  # Update with your Arduino port

# Define the digital pins for each point
pins = {
    0: board.get_pin('d:2:o'),  # Point 0.1
    1: board.get_pin('d:3:o')   # Point 0.2
}
...
# Define the two corner points (assuming a 640x480 resolution for simplicity)
corner_points = [
    (80, 570),  # Point 0.1
    (860, 80)    # Point 0.2
]
...
while cap.isOpened():
    ...
    # Draw body detections and determine the nearest corner points
    ...
    # Display the image
    cv2.imshow('YOLOv3 Body Detection with Nearest Corner Points', image)
